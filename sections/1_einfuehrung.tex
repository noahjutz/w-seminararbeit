...
% 1.3.1 Was ist es?
Die IR-Spektroskopie ist eine Methode der Molekülspektroskopie, welche sich mit den zwischenmolekularen Kräften in Molekülstrukturen beschäftigt \cite{ir_vibrations_bgr}. Bei der Infrarotspektroskopie werden Wellen im mittleren Infrarotbereich (\SI{3}{\micro\metre} bis \SI{8}{\micro\metre}) \cite{TODO} zerlegt.
